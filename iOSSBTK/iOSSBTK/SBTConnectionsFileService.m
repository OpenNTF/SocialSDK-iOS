...
@implementation SBTConnectionsFileService
...
- (void) getFileWithFileId:(NSString *) fileId
                parameters:(NSMutableDictionary *) parameters
                   success:(void (^)(SBTFileEntry *)) success
    ...
    if (fileId == nil) {
        ...
        failure([NSError errorWithDomain:@"SBTConnectionsFileService"
                                    code:100
...
- (void) getCommentsForPublicFile:(SBTFileEntry *) file
...
- (void) getCommentsForFile:(SBTFileEntry *) file
             withParameters:(NSMutableDictionary *) parameters
                    success:(void (^)(NSMutableArray *)) success
                    failure:(void (^)(NSError *)) failure {
...
- (void) getMyCommentsForFile:(SBTFileEntry *) file
               withParameters:(NSMutableDictionary *) parameters
                      success:(void (^)(NSMutableArray *)) success
                      failure:(void (^)(NSError *)) failure {
...
- (void) updateMetadataForFile:(SBTFileEntry *) file
                    parameters:(NSMutableDictionary *) parameters
...
- (void) addCommentToFile:(SBTFileEntry *) file
               parameters:(NSMutableDictionary *) parameters
                  comment:(NSString *) comment
                  success:(void (^)(SBTFileCommentEntry *)) success
                  failure:(void (^)(NSError *)) failure {
...
- (void) addCommentToMyFile:(SBTFileEntry *) file
                 parameters:(NSMutableDictionary *) parameters
                    comment:(NSString *) comment
                    success:(void (^)(SBTFileCommentEntry *)) success
                    failure:(void (^)(NSError *)) failure {
...
- (void) deleteCommentForFile:(SBTFileEntry *) file
...
- (void) deleteMyCommentForFile:(SBTFileEntry *) file
                      commentId:(NSString *) commentId
                     parameters:(NSMutableDictionary *) parameters
                        success:(void (^)(BOOL)) success
                        failure:(void (^)(NSError *)) failure {
...
- (void) updateCommentForFile:(SBTFileEntry *) file
                    commentId:(NSString *) commentId
                      comment:(NSString *) comment
                   parameters:(NSMutableDictionary *) parameters
                      success:(void (^)(SBTFileCommentEntry *)) success
...
- (void) updateMyCommentForFile:(SBTFileEntry *) file
                      commentId:(NSString *) commentId
                        comment:(NSString *) comment
                     parameters:(NSMutableDictionary *) parameters
                        success:(void (^)(SBTFileCommentEntry *)) success
...
- (void) createFolderWithName:(NSString *) folderName
    ...
    [[self getClientService] initPostRequestWithPath:path
                                          ...
                                          parameters:parameters
                                              format:RESPONSE_XML
                                             success:^(id response, id result) {
                                                 SBTFileEntry *entry = [[SBTFileEntry alloc] initWithXMLDocument:result];
                                                 success(entry);
    ...
    [self getNonceWithSuccess:^(NSString *nonce) {
        ...
        [[self getClientService] initMultiPartFileUploadRequestWithPath:path
                                                             ...
                                                             parameters:parameters
                                                                ...
                                                                success:^(id response, id result) {
                                                                    NSError *error = nil;
                                                                    NSArray *array = [((SBTXMLDocument *)result) nodesForXPath:@"/html/body" error:&error];
...
- (NSMutableArray *) convertFileListWithXML:(SBTXMLDocument *) document {
    ...
    if (document != nil) {
        ...
        if (entryList != nil && [entryList count] > 0) {
            ...
            for (GDataXMLElement *element in entryList) {
                ...
                SBTFileEntry *f = [[SBTFileEntry alloc] initWithXMLDocument:doc];
...
- (NSMutableArray *) convertCommentListWithXML:(SBTXMLDocument *) document {
    ...
    if (document != nil) {
        ...
        if (entryList != nil && [entryList count] > 0) {
            ...
            for (GDataXMLElement *element in entryList) {
                ...
                SBTXMLDocument *doc = [[SBTXMLDocument alloc] initWithRootElement:element];
                // Create a profile object and add it to the array
                SBTFileCommentEntry *c = [[SBTFileCommentEntry alloc] initWithXMLDocument:doc];
...
- (NSString *) constructBodyForFile:(SBTFileEntry *) file withPayloadDict:(NSMutableDictionary *) payloadDict {
