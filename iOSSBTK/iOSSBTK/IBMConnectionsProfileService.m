...
@implementation IBMConnectionsProfileService
...
- (void) getProfile:(NSString *) userId success:(void (^)(IBMConnectionsProfile *)) success failure:(void (^)(NSError *)) failure {
    ...
    [[self getClientService] initGetRequestWithPath:path
                                         parameters:dict
                                            ...
                                            success:^(id response,id result) {
                                                IBMConnectionsProfile *connProfile = [[IBMConnectionsProfile alloc] initWithXMLDocument:result];
                                                success(connProfile);
...
- (void) updateProfile:(IBMConnectionsProfile *) profile success:(void (^)(BOOL)) success failure:(void (^)(NSError *)) failure {
...
- (void) getColleaguesWithProfile:(IBMConnectionsProfile *) profile success:(void (^)(NSMutableArray *))success failure:(void (^)(NSError *))failure {
...
- (void) getColleaguesWithProfile:(IBMConnectionsProfile *) profile parameters:(NSMutableDictionary *) parameters success:(void (^)(NSMutableArray *))success failure:(void (^)(NSError *))failure {
...
- (NSMutableArray *) convertToProfileListWithXML:(IBMXMLDocument *) document {
    
    NSMutableArray *listOfProfiles = nil;
    if (document != nil) {
        
        NSError *error;
        NSDictionary *dict = [IBMConnectionsProfile namespacesForProfile];
        ...
        if (entryList != nil && [entryList count] > 0) {
            ...
            for (GDataXMLElement *element in entryList) {
                ...
                IBMXMLDocument *doc = [[IBMXMLDocument alloc] initWithRootElement:rootElement];
                // Create a profile object and add it to the array
                IBMConnectionsProfile *profile = [[IBMConnectionsProfile alloc] initWithXMLDocument:doc];
