...
@interface IBMConnectionsCommunity ()

@property (strong, nonatomic) NSMutableDictionary *xpathMap;

@end

@implementation IBMConnectionsCommunity
...
- (NSString *) constructRequestBody {
    ...
    if (self.parentCommunityUuid != nil) {
        requestBody = [requestBody stringByAppendingFormat:@"<link rel=\"http://www.ibm.com/xmlns/prod/sn/parentcommunity\" href=\"%@/communities/service/atom/community/instance?communityUuid=%@\"></link>", [IBMUtils getUrlForEndPoint:@"connections"], self.parentCommunityUuid];
    }
