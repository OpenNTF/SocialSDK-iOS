...
#import "IBMActivityStreamCommunity.h"
#import "IBMActivityStreamAttachment.h"

@interface IBMActivityStreamEntry : NSObject

@property (strong, nonatomic) NSString *title;
@property (strong, nonatomic) NSString *verb;
@property (strong, nonatomic) NSString *shortTitle;
@property (strong, nonatomic) IBMActivityStreamActor *actor;
@property (strong, nonatomic) NSString *objectType;
@property (strong, nonatomic) NSString *published;
@property (strong, nonatomic) NSString *url;
@property (strong, nonatomic) NSString *updated;
@property (strong, nonatomic) NSString *eId;
@property (strong, nonatomic) IBMActivityStreamCommunity *community;
