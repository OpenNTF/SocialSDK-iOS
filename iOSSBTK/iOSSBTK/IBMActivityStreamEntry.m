...
@implementation IBMActivityStreamEntry

+ (IBMActivityStreamEntry *) createActivityStreamEntryObjectFromDictionary:(NSDictionary *) dict {
...
+ (NSMutableArray *) fetchComments:(NSMutableDictionary *) targetDict {
    ...
    for (NSMutableDictionary *entry in list) {
        IBMActivityStreamEntry *newEntry = [[IBMActivityStreamEntry alloc] init];
        IBMActivityStreamActor *newActor = [[IBMActivityStreamActor alloc] init];
...
+ (IBMActivityStreamCommunity *) fetchCommunity:(NSMutableDictionary *) targetDict {
    NSString *communityPattern = @"urn:lsid:lconn.ibm.com:communities.community:";
    IBMActivityStreamCommunity *community = [[IBMActivityStreamCommunity alloc] init];
