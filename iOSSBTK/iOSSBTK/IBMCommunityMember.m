...
@interface IBMCommunityMember ()

@property (strong, nonatomic) NSMutableDictionary *xpathMap;

@end

@implementation IBMCommunityMember
...
- (id) getFieldWithXPath:(NSString *) fieldName {
    ...
    NSError *error;
    NSDictionary *dict = [IBMCommunityMember namespacesForCommunityMember];
...
- (NSString *) constructRequestBody {
    ...
    if ([IBMUtils isEmail:self.userId]) {
