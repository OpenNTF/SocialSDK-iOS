...
@implementation IBMConnectionsCommunityService
    ...
    [[self getClientService] initGetRequestWithPath:path
                                         parameters:dict
                                            ...
                                            success:^(id response, id result) {
                                                IBMConnectionsCommunity *community = [[IBMConnectionsCommunity alloc] initWithXMLDocument:result];
                                                success(community);
    ...
    [[self getClientService] initPostRequestWithPath:urlStr
                                         ...
                                         parameters:params
                                            ...
                                            success:^(id response, id result) {
                                                ...
                                                [self getCommunityWithUuid:communityUuid success:^(IBMConnectionsCommunity *comm) {
...
- (void) deleteMember:(IBMCommunityMember *) member
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   community.communityUuid, @"communityUuid",
                                   member.userId, ([IBMUtils isEmail:member.userId]?@"email":@"userid"),
                                   nil];
    NSString *auth = @"";
    if ([[self.endPoint getAuthType] isEqualToString:OAUTH2]) {
        auth = [NSString stringWithFormat:@"/%@", [self.endPoint getAuthType]];
...
- (NSMutableArray *) convertToCommunityListWithXML:(IBMXMLDocument *) document {
    
    NSMutableArray *listOfCommunity = nil;
    if (document != nil) {
        NSError *error;
        NSDictionary *dict = [IBMConnectionsCommunity namespacesForCommunity];
        ...
        if (entryList != nil && [entryList count] > 0) {
            ...
            for (GDataXMLElement *element in entryList) {
                ...
                IBMConnectionsCommunity *comm = [[IBMConnectionsCommunity alloc] initWithXMLDocument:doc];
...
- (NSMutableArray *) convertToCommunityMembersWithXML:(IBMXMLDocument *) document {
    ...
    if (document != nil) {
        ...
        if (entryList != nil && [entryList count] > 0) {
            ...
            for (GDataXMLElement *element in entryList) {
                ...
                IBMXMLDocument *doc = [[IBMXMLDocument alloc] initWithRootElement:element];
                // Create a profile object and add it to the array
                IBMCommunityMember *comm = [[IBMCommunityMember alloc] initWithXMLDocument:doc];
...
- (NSMutableArray *) convertToCommunityBookmarksWithXML:(IBMXMLDocument *) document {
    ...
    if (document != nil) {
        ...
        if (entryList != nil && [entryList count] > 0) {
            ...
            for (GDataXMLElement *element in entryList) {
                ...
                IBMXMLDocument *doc = [[IBMXMLDocument alloc] initWithRootElement:element];
                // Create a profile object and add it to the array
                IBMCommunityBookmark *bookmark = [[IBMCommunityBookmark alloc] initWithXMLDocument:doc];
...
- (NSMutableArray *) convertToCommunityForumTopicsWithXML:(IBMXMLDocument *) document {
    ...
    if (document != nil) {
        ...
        if (entryList != nil && [entryList count] > 0) {
            ...
            for (GDataXMLElement *element in entryList) {
                ...
                IBMXMLDocument *doc = [[IBMXMLDocument alloc] initWithRootElement:element];
                // Create a profile object and add it to the array
                IBMCommunityForumTopic *fTopic = [[IBMCommunityForumTopic alloc] initWithXMLDocument:doc];
