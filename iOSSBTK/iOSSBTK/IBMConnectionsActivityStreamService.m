...
@implementation IBMConnectionsActivityStreamService
...
- (void) getActivityStreamsWithParameters:(NSMutableDictionary *) parameters
    ...
    if ([app isEqualToString:[IBMASApplication convertToString:A_NOAPP]])
        app = @"";
...
- (void) getMyStatusUpdatesWithParameters:(NSMutableDictionary *) parameters
    ...
    [self getActivityStreamsWithParameters:parameters
                             fromUserType:[IBMASUser convertToString:U_ME]
                                groupType:[IBMASGroup convertToString:G_ALL]
                                  appType:[IBMASApplication convertToString:A_STATUS]
...
- (void) getAllUpdatesWithParameters:(NSMutableDictionary *) parameters
    ...
    [self getActivityStreamsWithParameters:parameters
                              fromUserType:[IBMASUser convertToString:U_PUBLIC]
                                 groupType:[IBMASGroup convertToString:G_ALL]
                                   appType:[IBMASApplication convertToString:A_ALL]
                                   success:^(NSMutableArray *list) {
                                       success(list);
                                   } failure:^(NSError *error) {
                                       failure(error);
...
- (void) getUpdatesFromMyNetworkWithParameters:(NSMutableDictionary *) parameters
    ...
    [self getActivityStreamsWithParameters:parameters
                              fromUserType:[IBMASUser convertToString:U_ME]
                                 groupType:[IBMASGroup convertToString:G_FRIENDS]
                                   appType:[IBMASApplication convertToString:A_ALL]
                                   success:^(NSMutableArray *list) {
                                       success(list);
                                   } failure:^(NSError *error) {
...
- (void) getUpdatesFromPeopleIFollowWithParameters:(NSMutableDictionary *) parameters
    ...
    [self getActivityStreamsWithParameters:parameters
                              fromUserType:[IBMASUser convertToString:U_ME]
                                 groupType:[IBMASGroup convertToString:G_FOLLOWING]
                                   appType:[IBMASApplication convertToString:A_STATUS]
                                   success:^(NSMutableArray *list) {
                                       success(list);
                                   } failure:^(NSError *error) {
...
- (void) getUpdatesFromCommunitiesIFollowWithParameters:(NSMutableDictionary *) parameters
    ...
    [self getActivityStreamsWithParameters:parameters
                              fromUserType:[IBMASUser convertToString:U_ME]
                                 groupType:[IBMASGroup convertToString:G_ALL]
                                   appType:[IBMASApplication convertToString:A_COMMUNITIES]
                                   success:^(NSMutableArray *list) {
                                       success(list);
                                   } failure:^(NSError *error) {
                                       failure(error);
...
- (void) getUpdatesFromUserWithUserId:(NSString *) userId
    ...
    [self getActivityStreamsWithParameters:parameters
                              fromUserType:userId
                                 groupType:[IBMASGroup convertToString:G_INVOLVED]
                                   appType:[IBMASApplication convertToString:A_ALL]
                                   success:^(NSMutableArray *list) {
                                       success(list);
                                   } failure:^(NSError *error) {
...
- (void) getUpdatesFromCommunityWithCommunityId:(NSString *) communityId
    ...
    [self getActivityStreamsWithParameters:parameters
                              fromUserType:[NSString stringWithFormat:@"%@%@", [IBMASUser convertToString:U_COMMUNITY], communityId]
                                 groupType:[IBMASGroup convertToString:G_ALL]
                                   appType:[IBMASApplication convertToString:A_NOAPP]
                                   success:^(NSMutableArray *list) {
                                       success(list);
                                   } failure:^(NSError *error) {
                                       failure(error);
...
- (void) getNotificationsForMeWithParameters:(NSMutableDictionary *) parameters
    ...
    [self getActivityStreamsWithParameters:parameters
                              fromUserType:[IBMASUser convertToString:U_ME]
                                 groupType:[IBMASGroup convertToString:G_NOTESFORME]
                                   appType:[IBMASApplication convertToString:A_NOAPP]
                                   success:^(NSMutableArray *list) {
                                       success(list);
                                   } failure:^(NSError *error) {
...
- (void) getResponsesToMyContentWithParameters:(NSMutableDictionary *) parameters
    ...
    [self getActivityStreamsWithParameters:parameters
                              fromUserType:[IBMASUser convertToString:U_ME]
                                 groupType:[IBMASGroup convertToString:G_RESPONSES]
                                   appType:[IBMASApplication convertToString:A_NOAPP]
                                   success:^(NSMutableArray *list) {
                                       success(list);
                                   } failure:^(NSError *error) {
...
- (void) getMyActionableViewWithParameters:(NSMutableDictionary *) parameters
    ...
    [self getActivityStreamsWithParameters:parameters
                              fromUserType:[IBMASUser convertToString:U_ME]
                                 groupType:[IBMASGroup convertToString:G_ACTION]
                                   appType:[IBMASApplication convertToString:A_NOAPP]
                                   success:^(NSMutableArray *list) {
                                       success(list);
                                   } failure:^(NSError *error) {
...
- (void) getMySavedViewWithParameters:(NSMutableDictionary *) parameters
    ...
    [self getActivityStreamsWithParameters:parameters
                              fromUserType:[IBMASUser convertToString:U_ME]
                                 groupType:[IBMASGroup convertToString:G_SAVED]
                                   appType:[IBMASApplication convertToString:A_NOAPP]
                                   success:^(NSMutableArray *list) {
                                       success(list);
                                   } failure:^(NSError *error) {
...
- (void) postEntryWithUserType:(AS_USER_TYPE) user
    ...
    NSString *path = [NSString stringWithFormat:@"%@/%@/rest/activitystreams/%@/%@/%@",
                      OPENSOCIAL_URL,
                      [self.endPoint getAuthType],
                      [IBMASUser convertToString:user],
                      [IBMASGroup convertToString:group],
                      [IBMASApplication convertToString:app]];
...
- (void) postEntry:(NSDictionary *) jsonPayload
    ...
    NSString *path = [NSString stringWithFormat:@"%@/%@/rest/activitystreams/%@/%@/%@",
                      OPENSOCIAL_URL,
                      [self.endPoint getAuthType],
                      [IBMASUser convertToString:U_ME],
                      [IBMASGroup convertToString:G_ALL],
                      [IBMASApplication convertToString:A_ALL]];
    [[self getClientService] initPostRequestWithPath:path
                                             headers:headers
                                          parameters:parameters
                                              format:RESPONSE_JSON
...
- (void) postMBEntryUserType:(NSString *) user
    ...
    if (user == nil)
        user = [IBMASUser convertToString:U_ME];
    if (group == nil)
        group = [IBMASGroup convertToString:G_ALL];
    if (app == nil)
        app = @"";
...
- (NSMutableArray *) convertToActivityStreamEntriesFromJSON:(NSMutableDictionary *) json {
    ...
    if (listOfEntries != nil && [listOfEntries count] > 0) {
        for (NSMutableDictionary *entry in listOfEntries) {
            IBMActivityStreamEntry *streamEntry = [IBMActivityStreamEntry createActivityStreamEntryObjectFromDictionary:entry];
