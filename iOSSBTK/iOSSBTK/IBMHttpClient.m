...
+ (void) deleteLtpaToken {
    NSArray *cookies = [[NSHTTPCookieStorage sharedHTTPCookieStorage] cookiesForURL:[NSURL URLWithString:[IBMUtils getUrlForEndPoint:@"connections"]]];
