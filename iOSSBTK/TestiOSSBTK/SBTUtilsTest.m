...
+ (void) setCredentials {
    ...
    [SBTCredentialStore storeWithKey:@"IBM_CREDENTIAL_ACME_URL" value:TEST_ACME_BASE_URL];
    [SBTCredentialStore storeWithKey:IBM_CREDENTIAL_USERNAME value:TEST_ACCOUNT_EMAIL];
    [SBTCredentialStore storeWithKey:IBM_CREDENTIAL_PASSWORD value:TEST_ACCOUNT_PASSWORD];
}
