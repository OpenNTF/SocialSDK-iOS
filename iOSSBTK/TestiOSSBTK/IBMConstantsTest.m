...
//NSString* const TEST_BASE_URL = @"https://vhost0120.dc1.on.ca.compute.ihost.com:444";
NSString* const TEST_BASE_URL = @"https://qs.renovations.com:444";
NSString* const TEST_ACME_BASE_URL = @"http://acmeairlines:8080";
NSString* const TEST_ACCOUNT_EMAIL = @"fadams@renovations.com";
//NSString* const TEST_ACCOUNT_PASSWORD = @"Passw0rd1";
NSString* const TEST_ACCOUNT_PASSWORD = @"passw0rd";
NSString* const TEST_ACCOUNT_USERID = @"B76AF020-4DAE-54F9-8525-7B7F0081881B";
