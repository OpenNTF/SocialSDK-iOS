...
#import "SBTConnectionsFileServiceTest.h"
#import "SBTUtilsTest.h"
#import "SBTConstantsTest.h"
#import "SBTConnectionsFileService.h"

@implementation SBTConnectionsFileServiceTest

SBTFileEntry *testFile;
SBTFileCommentEntry *testComment;
NSString *fileId = @"";
NSString *folderId = @"";
...
+ (void)setUp
{
    ...
    void (^testBlock)(void (^completionBlock)(void)) = ^(void (^completionBlock)(void)) {
        ...
        NSMutableDictionary *parameters = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                    @"public", @"visibility",
                                    nil];
        SBTConnectionsFileService *fS = [[SBTConnectionsFileService alloc] init];
        [fS uploadFileWithContent:content fileName:TEST_FILE_NAME mimeType:@"text/plain" success:^(SBTFileEntry *file) {
            testFile = file;
            fileId = file.fileId;
            SBTConnectionsFileService *fS_ = [[SBTConnectionsFileService alloc] init];
            [fS_ addCommentToMyFile:file parameters:parameters comment:TEST_FILE_COMMENT success:^(SBTFileCommentEntry *comment) {
                testComment = comment;
                // Now add a folder
                SBTConnectionsFileService *fS__ = [[SBTConnectionsFileService alloc] init];
                [fS__ createFolderWithName:TEST_FODLER_NAME description:@"Test folder" shareWith:nil success:^(SBTFileEntry *folder) {
                    folderId = folder.fileId;
                    // Now add file to the folder
                    SBTConnectionsFileService *fS___ = [[SBTConnectionsFileService alloc] init];
...
- (void) testGetMyCommentsForFile {
    ...
    void (^testBlock)(void (^completionBlock)(void)) = ^(void (^completionBlock)(void)) {
        ...
        [fS getMyCommentsForFile:testFile withParameters:nil success:^(NSMutableArray *list) {
            ...
            SBTFileCommentEntry *c = [list objectAtIndex:0];
...
- (void) testCreateAndDeleteFolder {
    ...
    void (^testBlock)(void (^completionBlock)(void)) = ^(void (^completionBlock)(void)) {
        SBTConnectionsFileService *fS = [[SBTConnectionsFileService alloc] init];
        [fS createFolderWithName:@"iOSTestFolder" description:@"Folder to test..." shareWith:nil success:^(SBTFileEntry *file) {
            STAssertNotNil(file.fileId, @"File id is nil");
...
- (void) testGetFilesInFolder {
    ...
    void (^testBlock)(void (^completionBlock)(void)) = ^(void (^completionBlock)(void)) {
        ...
        [fS getFilesInFolderWithCollectionId:folderId parameters:nil success:^(NSMutableArray *list) {
            ...
            SBTFileEntry *f = [list objectAtIndex:0];
...
- (void) testGetFileWithFileId {
    ...
    void (^testBlock)(void (^completionBlock)(void)) = ^(void (^completionBlock)(void)) {
        SBTConnectionsFileService *fS = [[SBTConnectionsFileService alloc] init];
        [fS getFileWithFileId:testFile.fileId parameters:nil success:^(SBTFileEntry *file) {
            STAssertNotNil(file.fileId, @"File id is nil");
...
- (void) testUpdateMetadataForFile {
    ...
    void (^testBlock)(void (^completionBlock)(void)) = ^(void (^completionBlock)(void)) {
        ...
        [fS updateMetadataForFile:testFile parameters:nil payload:payloadDict success:^(SBTFileEntry *f) {
            STAssertNotNil(f.fileId, @"File id is nil");
...
- (void) testGetCommentWithCommentId {
    ...
    void (^testBlock)(void (^completionBlock)(void)) = ^(void (^completionBlock)(void)) {
        SBTConnectionsFileService *fS = [[SBTConnectionsFileService alloc] init];
        [fS getCommentWithCommentId:testComment.commentId forFile:testFile parameters:nil success:^(SBTFileCommentEntry *entry) {
...
- (void) testGetMyCommentWithCommentId {
    ...
    void (^testBlock)(void (^completionBlock)(void)) = ^(void (^completionBlock)(void)) {
        SBTConnectionsFileService *fS = [[SBTConnectionsFileService alloc] init];
        [fS getMyCommentWithCommentId:testComment.commentId forFile:testFile parameters:nil success:^(SBTFileCommentEntry *entry) {
            STAssertNotNil(entry.commentId, @"Comment id is nil");
            STAssertEqualObjects(entry.commentId, testComment.commentId, @"Comment ids are different");
            STAssertEqualObjects(entry.comment, testComment.comment, @"Comment are different");
            completionBlock();
...
- (void) testAddUpdateAndDeleteCommentFromFile {
    ...
    void (^testBlock)(void (^completionBlock)(void)) = ^(void (^completionBlock)(void)) {
        ...
        [fS addCommentToFile:testFile parameters:nil comment:comment success:^(SBTFileCommentEntry *comment) {
            STAssertNotNil(comment.commentId, @"Comment id is nil");
            SBTConnectionsFileService *fS_ = [[SBTConnectionsFileService alloc] init];
            NSString *newComment = @"update to comment";
            [fS_ updateCommentForFile:testFile commentId:comment.commentId comment:newComment parameters:nil success:^(SBTFileCommentEntry *entry) {
                STAssertNotNil(entry.commentId, @"Comment id is nil");
...
- (void) testAddUpdateAndDeleteMyCommentFromFile {
    ...
    void (^testBlock)(void (^completionBlock)(void)) = ^(void (^completionBlock)(void)) {
        ...
        [fS addCommentToFile:testFile parameters:nil comment:comment success:^(SBTFileCommentEntry *comment) {
            ...
            SBTConnectionsFileService *fS_ = [[SBTConnectionsFileService alloc] init];
            NSString *newComment = @"update to comment";
            [fS_ updateMyCommentForFile:testFile commentId:comment.commentId comment:newComment parameters:nil success:^(SBTFileCommentEntry *entry) {
                STAssertNotNil(entry.commentId, @"Comment id is nil");
                STAssertEqualObjects(entry.comment, newComment, @"Comments are not equal");
                SBTConnectionsFileService *fS__ = [[SBTConnectionsFileService alloc] init];
