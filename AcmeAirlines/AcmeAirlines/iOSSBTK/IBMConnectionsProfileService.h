...
@interface IBMConnectionsProfileService : IBMBaseService
...
/**
 ...
 @param failure: block to return error
 */
- (void) getColleaguesWithProfile:(IBMConnectionsProfile *) profile parameters:(NSDictionary *) parameters success:(void (^)(NSMutableArray *))success failure:(void (^)(NSError *))failure;
