...
@interface IBMFileEntry : NSObject
...
@property (strong, nonatomic) IBMFileCommentEntry *commentEntry;
@property (strong, nonatomic) IBMFilePersonEntry *personEntry;
...
@property (strong, readonly) IBMFilePersonEntry *modifier;
