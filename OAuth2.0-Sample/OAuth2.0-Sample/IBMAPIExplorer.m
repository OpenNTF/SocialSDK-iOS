...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        IBMConnectionsCommunityService *commSrvc = [[IBMConnectionsCommunityService alloc] initWithEndPointName:@"connectionsOA2"];
        [commSrvc getMyCommunitiesWithSuccess:^(NSMutableArray *listOfCommunities) {
            for (IBMConnectionsCommunity *comm in listOfCommunities) {
        ...
        IBMConnectionsActivityStreamService *actService = [[IBMConnectionsActivityStreamService alloc] initWithEndPointName:@"connectionsOA2"];
        [actService getMyActionableViewWithParameters:nil
                                              success:^(NSMutableArray * list) {
                                                  for (IBMActivityStreamEntry *entry in list) {
        ...
        IBMConnectionsFileService *fS = [[IBMConnectionsFileService alloc] initWithEndPointName:@"connectionsOA2"];
        [fS uploadFileWithContent:content
                         fileName:fileName
                         mimeType:@"text/plain"
                          success:^(IBMFileEntry *file) {
